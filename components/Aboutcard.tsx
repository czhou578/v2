      ...
      <div className={styles.paragraphpic}>
        <div className={styles.paragraphBox}>
          <pre className={styles.paragraph}>
            ...
            millions around the world. I am currently a student in college
            studying Computer Science. My dream is to be able to help design and
            architect platforms that would help problem solvers communicate
            their solutions to a pressing problem to the world.
          </pre>
        </div>
